# mcp_servers/small_agent_server.py
...
#          "small-agent": {
#            "command": "python",
#            "args": ["-m", "mcp_servers.small_agent_server"],
...
def build_mcp_tools_from_registry():
    ...
    from mcp_servers.tool_adapter import openai_to_mcp_list
...
def execute_mcp_tool(name: str, args: dict) -> str:
    ...
    if name == "business_resolve":
        from business.business_layer import get_business_layer, BusinessNotFoundError
    ...
    # ── 通用工具（代理到现有 tool 引擎） ──
    from core.llm_engine import execute_tool
