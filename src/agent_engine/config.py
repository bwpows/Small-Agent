...
# ── 网络环境准备 ──
os.environ["NO_PROXY"] = "localhost,127.0.0.1"       # 阻止代理冲突，直连本地 Ollama
os.environ["MEM0_TELEMETRY"] = "False"                # 关闭 Mem0 隐私埋点
os.environ.setdefault("HF_ENDPOINT", "https://hf-mirror.com")  # HuggingFace 镜像加速
...
TRACE_STORAGE_DIR = "data/workspace/.traces"
